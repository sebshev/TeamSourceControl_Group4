...
namespace TeamSourceControl_Group4
{
    ...
    {
        // 컨텍스트가 응용 프로그램의 구성 파일(App.config 또는 Web.config)의 'VideoGameContext' 연결 문자열을 
        // 사용하도록 구성되었습니다. 기본적으로 이 연결 문자열은 LocalDb 인스턴스의  
        // 'TeamSourceControl_Group4.VideoGameContext' 데이터베이스를 대상으로 합니다. 
        // 
        // 다른 데이터베이스 및/또는 데이터베이스 공급자를 대상으로 할 경우 응용 프로그램 구성 파일에서 'VideoGameContext' 
        // 연결 문자열을 수정하십시오.
